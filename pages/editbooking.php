...
<html>
    ...
    <td>IDKonsultan</td>
    <td>:</td>
    <td><input type="text" class="form-control" name="IDKonsultan" readonly value="<?php echo $objBooking->IDKonsultan; ?>">
    </tr>
    <tr>
    <td>jadwal</td>
    <td>:</td>
    ...
    <td>IDKategori</td>
    <td>:</td>
    <td><input type="text" class="form-control" name="IDKategori" readonly value="<?php echo $objBooking->IDKategori; ?>">
    </tr>
